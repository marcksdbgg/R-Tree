...
public:
    ...
    // Graficar el arbol
    void DrawTree(Node* a_node);

    void GetWindowSize(int& width, int& height); // Get the window size
    ...
    void Search(Node* a_node, const int a_min[2], const int a_max[2], vector<vector<pair<int, int>>>& result);
